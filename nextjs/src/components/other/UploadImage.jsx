...
export default function UploadImage(props) {
  ...
  return (
    <div className="relative mt-1 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 h-52">
      <div className="text-center group flex justify-center items-center flex-col">
        <svg
