  ...
  return (
    <>
      <aside
        ...
        aria-label="Sidebar">
        <div className="relative flex-1 flex flex-col min-h-full max-h-full border-r border-gray-200 bg-white pt-0">
              ...
              <ul className="space-y-2 pb-2 text-sm pt-5">
                <li className="!mb-5">
                  <a
                    ...
                    className="text-slate-600 font-medium rounded-lg flex items-center p-2 hover:text-slate-800 hover:bg-slate-100 text-slate-800 bg-slate-100 group">
                    <svg
                ...
                <li className="!mb-5">
                  <a
                    ...
                    <span className="ml-3">Mitra</span>
                  </a>
                  <ul className="mt-2 text-[13px]">
                    <li className="mb-2">
                      <a
                        ...
                        <span className="ml-3">Semua Mitra</span>
                      </a>
                    </li>
                    <li className="mb-2">
                      <a
                        ...
                        className="border-l ml-9 text-slate-500 font-medium rounded hover:border-blue-600 flex items-center p-1.5 hover:text-slate-700 group">
                        <span className="ml-3">Tambah Mitra</span>
                      </a>
                    </li>
                  </ul>
                </li>
