...
const NotFound = () => {
  return (
    <div class="w-full h-screen flex items-center justify-center px-5">
      <div class="border rounded-lg shadow w-full bg-white max-w-[360px] md:max-w-[390px] lg:max-w-[420px] p-5 lg:p-7 border-t-8 border-t-blue-600 flex flex-col items-center justify-center">
