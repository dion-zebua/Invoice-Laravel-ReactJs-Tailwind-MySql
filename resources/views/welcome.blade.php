...
<head>
    ...
    <meta name="description" content="API {{ env('APP_NAME') }}" />

    <meta property="og:title" content="API {{ env('APP_NAME') }}" />
    <meta property="og:description" content="API {{ env('APP_NAME') }}" />

    <meta property="og:type" content="website" />
    <meta property="og:url" content="{{ request()->url() }}" />
    <meta property="og:image" content="{{ env('APP_LOGO') }}" />
    <link rel="icon" href="{{ env('APP_LOGO') }}" sizes="500x500" type="image/x-icon">
